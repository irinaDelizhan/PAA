...
{
    public class AutonomousTesting
    {
        // Interface
        ...
        // Data processor
        [Test]
        public void Tests_GenerateReport_Positive()
        {
        ...
        [Test]
        public void Tests_GenerateReport_Negative1()
        {
            Storage.Instance.projects = new();
            Storage.Instance.states = new();
        ...
        [Test]
        public void Tests_GenerateReport_Negative2()
        {
            Storage.Instance.projects = new();
            Storage.Instance.states = new();
